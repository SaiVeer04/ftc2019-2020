...
public class FoundationBlueRight extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            strafeRight(0.3, 1000, 200); //strafe to the middle
            ...
            strafeLeft(0.5, 2500, 200); //move parallel

            moveBackward(0.5, 300, 500); //move up to the side

            strafeRight(0.5, 2500, 500); //push the foundation in

            moveForward(0.3, 800, 200); //move backward a bit
